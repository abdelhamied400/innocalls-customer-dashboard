...
const ZendeskTableHead = () => {
  ...
  const handleCreate = async () => {
    try {
      setIsCreating(true);
      const result = await zendeskCredentialService.create();
      setGeneratedApiKey(result.apiKey);
      queryClient.invalidateQueries({ queryKey: ["zendesk-credentials"] });
  ...
  return (
    <>
            ...
            >
              <RadioGroup value={status} onValueChange={setStatus}>
                <div className="flex items-center gap-2">
                  <RadioGroupItem value="active" id="zendesk-status-active" />
                  <Label htmlFor="zendesk-status-active">
                ...
                <div className="flex items-center gap-2">
                  <RadioGroupItem
                    value="inactive"
                    id="zendesk-status-inactive"
                  />
                  <Label htmlFor="zendesk-status-inactive">
      ...
      <ApiKeyDialog
        ...
        translationNamespace="developers.zendesk"
        downloadFileName="zendesk-api-key.txt"
      />
    </>
  );
};

export default ZendeskTableHead;
