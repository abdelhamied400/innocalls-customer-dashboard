...
export const columns = (t: any) => [
  {
    ...
    header: ({ column }: any) => (
      <SortingHead column={column}>
        {t("finished.columns.creationDate")}
      </SortingHead>
    ),
    cell: CreatedAtCell,
  },
  {
    accessorKey: "name",
    header: ({ column }: any) => (
      <SortingHead column={column}>{t("finished.columns.name")}</SortingHead>
    ),
  },
  {
    accessorKey: "status",
    header: t("finished.columns.status"),
    cell: StatusCell,
  },
  {
    header: t("finished.columns.actions"),
    cell: ActionsCell,
  },
];
