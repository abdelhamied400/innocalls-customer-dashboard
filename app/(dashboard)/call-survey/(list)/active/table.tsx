...
import CallSurveyActiveHead from "./head";
...
const CallSurveyActiveTable = () => {
  ...
  const { data, isLoading, isError, error } = useLocalizedQuery<{
    ...
    queryKey: ["call-survey-active-list", filters, pagination, sorting],
    queryFn: async () =>
...
export default CallSurveyActiveTable;
