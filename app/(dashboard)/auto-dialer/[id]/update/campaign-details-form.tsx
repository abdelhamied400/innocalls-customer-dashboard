...
import { AutoDialerUpdateStep1 } from "@/validation/AutoDialerUpdateCampaign";
...
const CampaignDetailsForm = ({ onNext }: CampaignDetailsFormProps) => {
  const t = useTranslations("autoDialer.updateCampaign.steps.details.form");
  const form = useFormContext<AutoDialerUpdateStep1>();
