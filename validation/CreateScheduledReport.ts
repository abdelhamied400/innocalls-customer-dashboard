  ...
  z
    .object({
      ...
      emailSubject: z
        .string()
        .trim()
        .min(2, t("form.validation.emailSubject.minLength"))
        .max(200, t("form.validation.emailSubject.maxLength")),
      report: z.string().min(1, t("form.validation.report.required")),
      dateRangeStart: z
        .string()
        .min(1, t("form.validation.dateRangeStart.required")),
      dateRangeEnd: z
        .string()
        .min(1, t("form.validation.dateRangeEnd.required")),
    ...
    .superRefine((data, ctx) => {
      ...
      if (
        ...
        (!data.dayOfMonth || data.dayOfMonth.trim() === "")
      ) {
        ctx.addIssue({
          code: z.ZodIssueCode.custom,
