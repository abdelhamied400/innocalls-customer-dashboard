...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    {...props}
  >
    <span className="absolute end-1 flex h-3.5 w-3.5 items-center justify-center">
